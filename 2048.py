...
class Game(tk.Frame):
    ...
    Color_grid = "#ffcc00"
    Color_EmptyCell = "#1A1110"
    Font_ScoreLabel = ("Verdana", 20)
    Font_Score = ("Helvetica", 24, "bold")
    ...
    def __init__(self):
        ...
        self.grid()
        self.master.title("2048 by Rookies")
    ...
    def GUI_maker(self):
        ...
        frame_score.place(relx=0.5, y=25, anchor="center")
        tk.Label(
            frame_score,
            text="Score-",
